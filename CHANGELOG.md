...
## [Unreleased] - feature/gradio-ui (2025-10-30)
  ...
  ## [Unreleased] - feature/streaming-inference (2025-11-05)

    - Add streaming inference support to the Gradio UI (toggleable).
    - Stream partial audio chunks to the UI while inference completes (generator-based flow).
    - Add example/streaming/smoke_test.py to validate streaming wiring locally.
